                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <a href="#" class="btn btn-dark btn_new_cliente"><i class="fas fa-user-plus"></i> Nuevo Cliente</a>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    <thead class="thead-dark">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#" id="add_product_venta" class="btn btn-secondary" style="display: none;">Agregar</a></td>
                                        </tr>
                                        <tr>
                                            <th>Código</th>
